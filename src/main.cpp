...
uint256 hashGenesisBlock("0xedf060880a41f8fe9c7521d663272673a510dfd193b0fdd918f2b34fdab34546");
...
static const int64 nTargetTimespan = 10 * 60; // Hashcoin: 6 minutes
static const int64 nTargetSpacing = 1 * 60; // Hashcoin: 60 seconds
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x2dce031bffba617ceafe6e499bb3b1cbae49e0076129bf4238bd220779331405");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("420840710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
        CBlock block;
        ...
        assert(block.hashMerkleRoot == uint256("0x8402aed0f0c6a2ddd573cbd6c8204653c16d914472e2b825583c7da08b2ec7b3"));
...
unsigned char pchMessageStart[4] = { 0x9f, 0xe3, 0xe8, 0xe0 }; // Hashcoin
